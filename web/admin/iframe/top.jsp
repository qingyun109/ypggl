            ...
            <TABLE height="100%" width="100%" border=0>
              ...
              <TR>
                <TD class=font_text width="40%">
                  <SCRIPT language=JavaScript src="<%=basePath %><%=dir %>/images/date.js"></SCRIPT>
                </TD>
                <TD class=font_text style="DISPLAY: none" align=right>
                <FONT color=#ffffff></FONT></TD>
                <TD style="DISPLAY: none" width="40%"></TD>
                <TD class=font_text align=right>
                  [<A class=white href="<%=path%>/<%=dir %>/system/editpwd.jsp" target="MainFrame">修改密码</A>]
                  [<A class=white onclick="return out(this)" href="<%=path%>/Admin.shtml?method=exit" target=_top>安全退出</A>]
