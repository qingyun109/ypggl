...
function check()
{
	if(document.form1.dwmc.value=="")
	{
		alert("请填写名称！");
		document.form1.dwmc.focus();
		return false;
	}
...
<%
	...
	String method=request.getParameter("method").trim();
		...
		String dwmc=Common.toChineseAndTrim(request.getParameter("dwmc"));
	   ...
	   <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		...
		<form name="form1" action="<%=basePath %>YaoServlet" method="post" onsubmit="return check()">
		  ...
		  <TR  align="center" bgColor=#ffffff>
			<TD width=40% id=map align=right>单位名称：<input type=hidden name=method value=<%=method %>><input type=hidden name=id value=<%=id %>></TD>
			<TD align=left><input type=text size=30 maxlength=50 name=dwmc > </TD>
		  </TR>
		   <TR  align="center" bgColor=#ffffff>
