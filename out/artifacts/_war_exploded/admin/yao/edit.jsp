...
<%
	...
	String method=request.getParameter("method").trim();
		...
		String mname=Common.toChineseAndTrim(request.getParameter("mname"));
	   ...
	   <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		...
		<form name="form1" action="<%=basePath %>YaoServlet" method="post" onsubmit="return check()">
		  ...
		  <TR  align="center" bgColor=#ffffff>
			<TD width=40% id=map align=right>药品名称：<input type=hidden name=method value=<%=method %>><input type=hidden name=id value=<%=id %>></TD>
			<TD align=left><input type=text size=30 maxlength=50 name=mname></TD>
		  </TR>
		   <TR  align="center" bgColor=#ffffff>
