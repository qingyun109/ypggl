...
function check()
{
	if(document.form1.flmc.value=="")
	{
		alert("请填写药品分类名称！");
		document.form1.flmc.focus();
		return false;
	}
...
<%
	...
	String method=request.getParameter("method").trim();
		...
		String yplb=Common.toChineseAndTrim(request.getParameter("yplb"));
	   ...
	   <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		...
		<form name="form1" action="<%=basePath %>YaoServlet" method="post" onsubmit="return check()">
		  ...
		  <TR  align="center" bgColor=#ffffff>
			<TD width=40% id=map align=right>类别名称：<input type=hidden name=method value=<%=method %>><input type=hidden name=id value=<%=id %>></TD>
			<TD align=left><input type=text size=30 maxlength=50 name=yplb > </TD>
		  </TR>
		   <TR  align="center" bgColor=#ffffff>
