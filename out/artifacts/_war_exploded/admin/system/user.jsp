...
<jsp:useBean id="lb" scope="page" class="main.java.com.bean.AdminBean" />
	...
	<form action="<%=basePath %>/Admin.shtml?method=manager" method="post" name="form1" onSubmit="return checkUser()">
       <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		...
		%>
		  <TR onClick=OnclikeTable(this) align="center" bgColor=#ffffff>
			...
			<TD id=map><%if(Integer.parseInt(list.get(1).toString())==2){out.println("删除");}else {%><a href="<%=basePath %>Admin.shtml?method=delm&id=<%=list3.get(0).toString()%>">删除</a><%} %></TD>
		  </TR>
		<%}}else{%>	
	   ...
	   <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		  ...
		  <TR  align="center" bgColor=#ffffff>
			...
			<TD width="60%" align="left" id=map><input type="text" name="username" value="<%=request.getAttribute("username")==null?"":request.getAttribute("username")%>" maxlength="10" size="18" class=input  onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[\W]/g,''))"
                              onkeyup="value=value.replace(/[\W]/g,'')"/>&nbsp;字母或数字6-10位</TD>
		  </TR>
		  <TR align="center" bgColor=#ffffff>
			<TD align="right" id=map>登录密码：</TD>
			<TD align="left" id=map><input type="text" name="password" maxlength="16" size="18" class=input  onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[\W]/g,''))"
		  ...
		  <TR align="center" bgColor=#ffffff>
			...
			<TD align="left" id=map><input type="radio" name="add" value="add" >增加&nbsp;<input type="radio" name="update" value="update" >修改</TD>
		  </TR>
		  <TR align="center" bgColor=#ffffff>
	   ...
	   <TABLE align="center" width="80%" border="0">
		...
		<TD align="left">
			<div align="left">      注意：<br>
                1、如增加管理员，请直接输入管理员名和登录密码，并选择管理级别和使用状态，选中“增加”按钮，确定即可。<br>
		        2、如修改管理员信息，请在页面中部文本框输入该管理员信息，修改后注意保持“修改”按钮为选中状态，确定即可。<br>
