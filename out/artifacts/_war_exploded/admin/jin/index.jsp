 ...
 <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		...
		%>
		  <TR  align="center" bgColor=#ffffff>
			...
			<TD id=map><a href="<%=basePath %>admin/jin/edit.jsp?method=upjinhuo&id=<%=list3.get(0).toString()%>">修改</a></TD>
			<TD id=map><a href="<%=basePath %>YaoServlet?method=deljin&id=<%=list3.get(0).toString()%>">删除</a></TD>
		  </TR>
		<%}}%>
		 </TBODY>
	   </TABLE>
